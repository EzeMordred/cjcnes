...
$sentencia = $conn->prepare("UPDATE detalle_costos_cursos SET id_curso = ?, costo_general = ?, costo_estudiante = ?, costo_egresado = ?, costo_graduado = ?, costo_docente = ?, costo_personal_administrativo = ? WHERE id_curso = ?");
