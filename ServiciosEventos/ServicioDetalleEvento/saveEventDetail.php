...
$sentencia = $conn->prepare("INSERT INTO eventos (id_evento, id_participante, tema_especifico, fecha_inicio, fecha_fin, hora_inicio, hora_fin, modalidad, enlace) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)");
