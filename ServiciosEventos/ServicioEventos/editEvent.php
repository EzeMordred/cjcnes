...
$sentencia = $conn->prepare("UPDATE eventos SET id_evento = ?, titulo = ?, subtitulo = ?, id_categoria = ?, fecha_inicio = ?, fecha_fin = ?, hora_inicio = ?, hora_fin = ?, id_ubicacion_general = ?, id_ubicacion_especifica = ?, aforo = ?, certificado = ?, asistencia = ? WHERE id_evento = ?");
